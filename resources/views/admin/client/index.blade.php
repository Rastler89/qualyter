    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                @if($client->delegation=='00' || $client->father == null)<a href="{{route('clients.download',['id'=>$client->id])}}" class="btn btn-outline-primary"><i class="align-middle" data-feather="download"></i></a>@endif
            </td>
        </tr>
        @endforeach
    </tbody>
