            ...
            <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff;">
              <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                ...
                <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                  ...
                  <?php 
                    $ot = json_decode($body['order']); 
                    $strip = date_format($body['created_at'],"d/m/Y");
                  ?>
								<p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Poppins,sans-serif;">{{__("During today we would need you to update the open issue with date :date, :ot - ':name_ot' and shop :shop ':shop_name' in order to follow up, thank you!", ['date' => $strip, 'ot' => $ot->code, 'name_ot' => $ot->name, 'shop' => $body['store'], 'shop_name' => $body['store_name']])}}</p>
								<a href="{{Request::getHost()}}/agent/incidence/{{$body['id']}}?code={{$body['token']}}"  style="box-sizing: border-box;display: inline-block;font-family:'Poppins',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff6600; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                    {{__('MORE INFORMATION')}}
                                  </a>
