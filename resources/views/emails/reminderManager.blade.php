              ...
              <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                ...
                <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                  ...
                  <?php 
                    ...
                    $strip = date_format(now(),"d/m/Y");
                  ?>
								<p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Poppins,sans-serif;">{{__("Today :date the following incidents are being monitored", ['date' => $strip])}}</p>
								<p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Poppins,sans-serif;">
                                    <ul>
                                    @foreach($body['incidences'] as $incidence)
                                    <?php $ot = json_decode($incidence['order']); ?>
                                        <li>{{$incidence->agent_name}}, {{$ot->code}} - {{$ot->name}}, {{$incidence->store}} - {{$incidence->store_name}}</li>
                                    @endforeach
                                    </ul>
                                    <a href="{{Request::getHost()}}/incidences"  style="box-sizing: border-box;display: inline-block;font-family:'Poppins',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff6600; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                    {{__('MORE INFORMATION')}}
                                  </a>
                                </p>
                              </div>
